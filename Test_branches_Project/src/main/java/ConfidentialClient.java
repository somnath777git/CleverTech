...
public class ConfidentialClient {
	...
	public static void main(String[] args) {
		SpringApplication.run(ConfidentialClient.class, args);
	}
}
...
class ProductController {
	...
	public void  getAjaxlist(HttpServletRequest request,HttpServletResponse response)
	{
		...
		AjaxServiceConfidentialClient ajaxService=new AjaxServiceConfidentialClient();
		System.out.println(ajaxService.getAjaxDataCall());
		JSONObject responseJson=new JSONObject();
		JSONObject jsonObject=null;
		JSONArray jsonArray=new JSONArray();
		for (AjaxModelConfidentialClient ajaxdata : ajaxService.getAjaxDataCall()) {
	...
	class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter 
	{
		...
		@Bean
		public CorsFilterConfidentialClient getCorsEnabled()
		{
			return new CorsFilterConfidentialClient();
		}
