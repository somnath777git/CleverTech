...
public class CorsFilterPublicClient implements Filter
{
	
   @Override
     public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		throws IOException, ServletException {
	  System.out.println("inside doFilter of 8888 domain>>>>");
      ...
      System.out.println("---CORS Configuration Completed for domain 8888---");
